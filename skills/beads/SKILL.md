...
| bd (persistent) | Session Todos (write_todos) (ephemeral) |
|-----------------|----------------------|
...
**When to use Session Todos (write_todos)**:
...
| Resource | Content |
|----------|---------|
| [BOUNDARIES.md](resources/BOUNDARIES.md) | bd vs Session Todos (write_todos) detailed comparison |
...
| [INTEGRATION_PATTERNS.md](resources/INTEGRATION_PATTERNS.md) | Session Todos (write_todos) and tool integration |
