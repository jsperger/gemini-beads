...
**The test:** Would a fresh Gemini instance (or you after 2 weeks) struggle to resume this work from the description alone? If yes, add implementation details.
...
**Problem:** Future Gemini doesn't know:
...
**Result:** Fresh Gemini instance can:
...
**The principle:** Help your future self (or next Gemini) resume without rediscovering everything.
